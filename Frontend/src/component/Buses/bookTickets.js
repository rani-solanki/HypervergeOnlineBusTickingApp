...
const BookTicket = ({ getTickets, bookSeats, buses, match, busStatus: { loading, status }, getBusStatus }) => {
    useEffect(() => {
                                        ...
                                        <ol class="cabin fuselage">
                                            <li class="row row--1">
                                                <ol class="seats" type="A">
                                                    ...
                                                    <li class="seat">
                                                        <input type="checkbox" value="1B" id={isBooked("1B")} />
...
export default connect(mapStateToProps, { getTickets,bookSeats, getBusStatus })(BookTicket);
